...
function SearchForm({handleSubmit, handleChange, searchQuery, handleSwitcher, isShortFilm, errorMessage}) {
  return (
    <section className='searchform'>
      <form className='searchform__wrapper' onSubmit={handleSubmit} noValidate>
        <div className='searchform__form'>
          ...
          <button className='searchform__button'  onSubmit={handleSubmit} type='submit'>
            <img
              src={buttonIcon}
              alt='кнопка поиска'
